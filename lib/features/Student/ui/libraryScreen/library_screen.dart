...
// import 'package:school/features/Student/ui/libraryScreen/reservations_dialog.dart';
...
//       builder: (context) =>
//           ReservationsDialog(reservationsBloc: reservationsBloc),
//     );
//   }
// }
// lib/features/Student/ui/libraryScreen/library_screen.dart
...
class _LibraryScreenState extends State<LibraryScreen>
  ...
  void initState() {
    ...
    // تفعيل الأنيميشن بعد بناء الإطار الأول لتجنب التقطيع عند الدخول
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        _isReadyToAnimate.value = true;
      }
  ...
  // ---------------------------------------------------------
  // مكونات الواجهة الفرعية (Search & Stats)
  // ---------------------------------------------------------
  Widget _buildSearchBar(BuildContext context) {
    final theme = Theme.of(context);
    return Container(
