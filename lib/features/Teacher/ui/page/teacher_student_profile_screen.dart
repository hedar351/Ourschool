...
// // ✅ معرفات أنواع الاختبارات
// enum QuizType {
//   quiz1(id: 1, label: 'اختبار أول'),
//   quiz2(id: 2, label: 'اختبار ثاني'),
//   homework(id: 3, label: 'واجب'),
//   finalExam(id: 5, label: 'نهائي');

//   final int id;
//   final String label;
//   const QuizType({required this.id, required this.label});
...
//     // ✅ توفير MarkBloc محلياً مع باقي الـ Blocs
//     return MultiBlocProvider(
//       providers: [
//         BlocProvider(
//           create: (context) => di.sl<TeacherStudentProfileBloc>()
...
//     final formKey = GlobalKey<FormState>();
//     int? selectedSemester = semester ?? (isEdit ? null : null);
//     QuizType? selectedQuizType;
//     final scoreController = TextEditingController();
//     final maxScoreController = TextEditingController();
...
//               return AlertDialog(
//                 title: Text(
//                   isEdit ? 'تعديل علامة' : 'إضافة علامة',
//                   style: TextStyle(
//                     fontSize: 18.sp,
//                     fontWeight: FontWeight.bold,
//                   ),
...
//                         }),
//                         validator: (value) =>
//                             value == null ? 'يرجى اختيار الفصل' : null,
//                       ),
//                       SizedBox(height: gapMedium),
...
//                         onChanged: (value) => setState(() {
//                           selectedQuizType = value;
//                           // ✅ تحديث حقل score عند تغيير نوع الاختبار
//                           updateScoreField(value);
//                         }),
//                         validator: (value) =>
//                             value == null ? 'يرجى اختيار نوع الاختبار' : null,
//                       ),
//                       SizedBox(height: gapMedium),
...
//                         validator: (value) {
//                           if (value == null || value.isEmpty) {
//                             return 'يرجى إدخال العلامة الكاملة';
//                           }
//                           if (double.tryParse(value) == null) {
//                             return 'يرجى إدخال رقم صحيح';
//                           }
...
//                               schoolId: widget.schoolId,
//                               localStudentNumber: widget.localStudentNumber,
//                               localSubjectId: 1, // يجب تحديد المادة
//                               semester: selectedSemester!,
//                               quizTypeId: selectedQuizType!.id,
//                               score: score,
//                               maxScore: maxScore,
...
//   //   required bool isEdit,
//   // }) async {
//   //   // ✅ احصل على الـ Bloc من السياق الحالي
//   //   final markBloc = context.read<MarkBloc>();
