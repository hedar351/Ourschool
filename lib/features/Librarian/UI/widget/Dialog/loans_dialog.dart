...
//                 ),
//                 child: Text(
//                   _getTranslatedLoanStatus(
//                     context,
//                     loan.statusName ?? 'Active',
//                   ),
//                   style: TextStyle(
//                     fontSize: 11.sp,
//                     fontWeight: FontWeight.bold,
...
//                 ),
//               ),
//               if (reservation.statusName == 'Active') ...[
//                 SizedBox(width: 8.w),
//                 Row(
//                   mainAxisSize: MainAxisSize.min,
//                   children: [
...
//   }
// }
// lib/features/Librarian/UI/widget/loans_dialog.dart
                ...
                Padding(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      context.read<AddDeleteEditBloc>().add(
                        ReturnLoansEvent(
                          localBookNumber: loan.localBookNumber ?? 0,
                          localStudentNumber: loan.localStudentNumber ?? 0,
                        ),
                      );
                    },
                    tooltip: 'إعادة',
